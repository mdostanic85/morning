...
- "ok": concrete findings that are satisfied or aligned. Name the exact requirement and the exact Figma frame/layer/copy that satisfies it.
- "notOk": concrete gaps — name the exact required screen, state, flow, component, or copy that is absent, incomplete, or contradicted.
