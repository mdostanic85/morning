...
- For EACH item, produce:
  - "reason": 3–5 plain-language sentences that work as a pre-work reminder before the person looks at today's steps. Reconstruct what was recently discussed, requested, validated, or agreed — especially from Granola/Gemini transcripts, Jira comments, and meeting notes. Name who said what when the sources do, what change was asked for, what was already checked or confirmed, and what is still open. Lead with the concrete work product (screen, flow, component, copy, or deliverable), then the newest trigger from meetings/comments. A teammate who missed the last call should understand the situation from this paragraph alone. Do not use vague phrases such as "work on", "address feedback", "make progress", or "review the task" without spelling out the concrete changes. Do not write a one-line CTA; do not merely restate the Jira title.
  ...
  - "todayWorkSummary": 2–5 short bullets shown on the main Today card. Each bullet must name a concrete deliverable from the newest meeting/Jira comments — screen, component, state, copy, count, or behavior (examples: "Design the 18-files-per-SKU expand edge case in Figma", "Finish remaining dropdown / row expand states", "Confirm worst-case file count with Sofija"). Never paraphrase doneCriteria. Never write "review the ticket" or "take necessary actions".
